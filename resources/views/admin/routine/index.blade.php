	     	...
	     	<div class="row bg-white">
	     		<div class="col-md-12">
	                 <div class="add-student">
	                 	<a class="admore" href="{{ url('routine/add') }}"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Add Routine</a>
	                 </div>
	     		</div>
	     		...
	     		<div class="col-md-12">
	     			<div class="col-md-6 col-md-offset-3">
	     				<div class="class-holder form-horizontal">
	     					{!! Form::open(array('url' => 'routine/index', 'files' => true)) !!}
